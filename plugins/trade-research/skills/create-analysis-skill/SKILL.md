...
2. Implement the `ResearchSkill` protocol against provider protocols in `src/trade_research/skills/`; use a frozen dataclass, accept validated observations only, and preserve provenance.
